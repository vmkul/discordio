...
module.exports = {
  ...
  async execute(message) {
    ...
    if (!message.member.voice.channel.members.has(user.value.id))
      return message.channel.send('The user is not connected ' +
    ...
    ffmpeg(audio).inputFormat('s16le')
      .outputFormat('mp3')
      .audioFilter('atempo=2,rubberband=pitch=2')
      .output(str)
      .on('end', () => {
